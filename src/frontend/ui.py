...
def manual_check_emails():
    ...
    try:
        ...
        # print("Processing Emails for Minutes : ",request.json.get('since_minutes', 43200))
        print("Processing Emails for Minutes : ",43200)
        # since_minutes = request.json.get('since_minutes', 60) if request.json else 60
        # since_minutes = request.json.get('since_minutes', 43200) if request.json else 43200
        since_minutes = 43200
