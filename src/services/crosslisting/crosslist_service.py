...
class CrosslistService:
    ...
    def check_and_crosslist(self, unit_id) -> Dict:
        ...
        """
        from src.backend.db.database import Unit, Listing, ListingUnit, Channel, ListingTemplate
    ...
    def _create_listing_on_platform(self, unit, template, platform: str) -> Dict:
        ...
        """
        from src.backend.db.database import Listing, ListingUnit, Channel
        from src.services.crosslisting.image_handler import ImageHandler
        ...
        try:
            ...
            if platform == 'poshmark':
                from src.services.crosslisting.poshmark_lister import PoshmarkLister
                lister = PoshmarkLister()
                result = lister.create_listing(platform_data, local_images)
        
            elif platform == 'mercari':
                from src.services.crosslisting.mercari_lister import MercariLister
    ...
    def _unit_needs_crosslist(self, unit_id) -> bool:
        ...
        """
        from src.backend.db.database import Unit, ListingTemplate
