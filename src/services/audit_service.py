...
class AuditService:
    ...
    def audit_sku_issues(self) -> Dict:
        ...
        Returns:
            dict: SKU issues
        """
        from src.backend.db.database import Listing, Unit, ListingUnit
    ...
    def audit_inventory_mismatches(self) -> Dict:
        ...
        """
        from src.backend.db.database import Unit, Listing, ListingUnit, Product
    ...
    def audit_pricing_issues(self) -> Dict:
        ...
        Returns:
            dict: Pricing issues
        """
        from src.backend.db.database import Unit, Product, Listing, ListingUnit
    ...
    def get_audit_summary(self) -> Dict:
        ...
        Returns:
            dict: Issue counts
        """
        from src.backend.db.database import Unit, Listing, ListingTemplate, Alert
