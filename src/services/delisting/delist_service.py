...
class DelistService:
    ...
    def _find_unit(self, parsed_email: Dict) -> Optional[object]:
        ...
        """
        from src.backend.db.database import Unit, Listing, ListingUnit
    ...
    def _find_unit_listings(self, unit_id) -> List:
        ...
        from src.backend.db.database import Listing, ListingUnit
    ...
    def _get_listing_platform(self, listing: object) -> str:
        ...
        from src.backend.db.database import Channel
    ...
    def _delist_from_platform(self, listing: object, platform: str) -> Dict:
        ...
        if platform == 'ebay':
            ...
            from src.services.delisting.ebay_delist import delist_ebay_item
        ...
        # elif platform in ['mercari',"pos"]:
            print(f"delisting from {platform}")
            print(listing.channel_listing_id)
            from src.services.delisting.selenium_delist import delist_item
