...
class BulkImportService:
    ...
    def import_products(self, valid_rows: List[Dict]) -> Dict:
        ...
        Returns:
            dict: Import results
        """
        from src.backend.db.database import Product, Category, ConditionGrade
    ...
    def import_units(self, valid_rows: List[Dict]) -> Dict:
        ...
        Returns:
            dict: Import results
        """
        from src.backend.db.database import Unit, Product, Location, ConditionGrade
    ...
    def _get_or_create_category(self, category_name: str):
        """Get or create category"""
        from src.backend.db.database import Category
    ...
    def _get_or_create_condition(self, condition_name: str):
        """Get or create condition grade"""
        from src.backend.db.database import ConditionGrade
